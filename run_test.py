...
print(); print(" *** Input forms actions were performed successfully! *** ")
...
driver.execute_script("window.scrollTo(0,document.documentElement.scrollHeight);");time.sleep(1)
print(); print(" *** Dropdown list actions were performed successfully! *** ")
driver.find_element_by_tag_name('body').send_keys(Keys.CONTROL + Keys.HOME);time.sleep(1)

# Range sliders
driver.get('https://www.seleniumeasy.com/test/drag-drop-range-sliders-demo.html');time.sleep(1)
print(); print(" *** Range slider actions started... *** ")
...
ActionChains(driver).click_and_hold(slider).move_by_offset(90, 0).release().perform()
print(); print(" *** Range slider actions were performed successfully! *** ");time.sleep(1)

# Copy paste
driver.get('https://www.seleniumeasy.com/test/input-form-demo.html');time.sleep(1)
print(); print(" *** Copy paste actions started... *** ")
...
print(); print(" *** Copy paste actions were performed successfully! *** ");time.sleep(1)
...
print(); print(" *** Drag and drop actions were performed successfully! *** ")
