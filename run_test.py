...
# Checkbox buttons
driver.find_element_by_xpath("//*[@id='treemenu']/li/ul/li[1]/a").click();time.sleep(1) # Input forms
driver.find_element_by_xpath("//*[@id='treemenu']/li/ul/li[1]/ul/li[2]/a").click();time.sleep(1) # checkbox buttons
...
driver.find_element_by_xpath("//*[@id='treemenu']/li/ul/li[5]/ul/li[2]/a").click();time.sleep(1) # Bootstrap modals
driver.find_element_by_xpath("/html/body/div[2]/div/div[2]/div[2]/div/div/div[2]/a").click();time.sleep(1) # launch multiple modals
