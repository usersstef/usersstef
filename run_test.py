...
driver.find_element_by_xpath("//*[@id='gettotal']/button").click(); time.sleep(1)  # get total button
...
driver.find_element_by_xpath("//*[@id='treemenu']/li/ul/li[1]/ul/li[2]/a").click();time.sleep(1)  # checkbox button
